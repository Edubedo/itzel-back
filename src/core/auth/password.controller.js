...
exports.forgotPassword = async (req, res) => {
  ...
  try {
    ...
    // Guarda el código y expiración en el usuario (puedes usar update)
...
exports.verifyCode = async (req, res) => {
  ...
  try {
    ...
    if (!usuario || !usuario.reset_code || !usuario.reset_code_expires) {
    ...
    if (
      ...
      new Date() > new Date(usuario.reset_code_expires)
    ) {
